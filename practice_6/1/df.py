...
df = pd.read_csv('[1]game_logs.csv')
...
columns_dtypes = {
    ...
    'attendance': pd.StringDtype,
    'length_minutes': pd.StringDtype,
    'v_manager_name': pd.CategoricalDtype,
    'v_score': pd.StringDtype,
    'v_errors': pd.StringDtype,
    'h_manager_name': pd.CategoricalDtype,
    'h_score': pd.StringDtype,
    'h_errors': pd.StringDtype
}

# write_header = True
# for chunk in pd.read_csv('[1]game_logs.csv',
